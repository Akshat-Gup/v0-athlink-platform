...
import { UserRole } from "../templates/user/join-role-selector"
...
export function MobileJoinRoleSelector({ isOpen, onOpenChange, onRoleSelect, children }: MobileJoinRoleSelectorProps) {
